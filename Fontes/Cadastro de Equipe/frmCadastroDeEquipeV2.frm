...
Begin VB.Form frmCadastroDeEquipeV2 
   ...
   Begin VB.Frame fraPrincipal 
      ...
      Begin VB.Frame fraInfoClube 
         ...
         Top             =   120
         Width           =   7665
         Begin TrueOleDBGrid80.TDBGrid ssgProcurarEquipe 
            Height          =   1875
            Left            =   1110
            TabIndex        =   34
            Top             =   810
            ...
            Splits(0)._ColumnProps(8)=   "Column(1).Width=6800"
            Splits(0)._ColumnProps(9)=   "Column(1).DividerColor=0"
            Splits(0)._ColumnProps(10)=   "Column(1)._WidthInPix=6720"
   ...
   Begin VB.Image imgbaixo 
      Height          =   135
      Left            =   0
      Picture         =   "frmCadastroDeEquipeV2.frx":5D56
      Top             =   0
      Visible         =   0   'False
      Width           =   165
   End
   Begin VB.Image imgcima 
      Height          =   135
      Left            =   180
      Picture         =   "frmCadastroDeEquipeV2.frx":5EDC
      Top             =   0
      Visible         =   0   'False
      Width           =   165
   End
...
20        Set mobjRsJogadores = Nothing
30        Set mobjRsJogadores = New Recordset

          
40        With mobjRsJogadores
50            .Fields.Append "Apelido", adVarChar, 1024
60            .Fields.Append "Cartegoria", adVarChar, 1024
70            .Fields.Append "Camisa", adVarChar, 1024
80            .Fields.Append "Nome", adVarChar, 1024
90            .Fields.Append "Sexo", adVarChar, 1024
100           .CursorLocation = adUseClient
110           .Open , Nothing, adOpenDynamic, adLockOptimistic
120       End With
          
130       If Not objRsJogadores Is Nothing Then
140           If Not objRsJogadores.BOF And Not objRsJogadores.EOF Then
150               objRsJogadores.MoveFirst
160               Do While Not objRsJogadores.EOF
170                   mobjRsJogadores.AddNew
                      
180                   mobjRsJogadores!Apelido = NS(objRsJogadores!APELIDO_VC)
190                   mobjRsJogadores!Cartegoria = NS(objRsJogadores!Descricao_VC)
200                   mobjRsJogadores!Camisa = NS(objRsJogadores!NUMEROCAMISA_IN)
210                   mobjRsJogadores!Nome = NS(objRsJogadores!NOMEATLETA_VC)
220                   mobjRsJogadores!Sexo = NS(objRsJogadores!SEXO_IN)
                      
230                   mobjRsJogadores.Update
240                   objRsJogadores.MoveNext
250               Loop
260           End If
270       End If
          
280       ssgJogadoresEquipe.DataSource = mobjRsJogadores
290       ssgJogadoresEquipe.Update

300   Exit Sub
Erro:
310      Call MsgBox("Erro no módulo: " & "frmCadastroDeEquipe" & vbCrLf & "No Procedimento: " & "CriarEPreencherRecordsetJogadores" & vbCrLf & "Descrição: " & Err.Description & vbCrLf & "Número: " & Err.Number & vbCrLf & "Na linha: " & Erl & vbCrLf & "Entre em contato com o suporte e mostre esta mensagem!", vbOKOnly + vbCritical, "Atenção!")
...
Private Sub ssgProcurarEquipe_Click()
On Error Resume Next
    ssgProcurarEquipe.SelBookmarks.Clear
    ssgProcurarEquipe.SelBookmarks.Add ssgProcurarEquipe.Bookmark
On Error GoTo 0
End Sub

Private Sub ssgProcurarEquipe_DblClick()
    txtCodigoInterno.Text = mobjRsEquipes!ID_IN
    If Val(txtCodigoInterno.Text) <> 0 Then
        txtCodigoInterno_KeyDown vbKeyReturn, 0
    End If
    ssgProcurarEquipe_LostFocus
End Sub

Private Sub ssgProcurarEquipe_HeadClick(ByVal ColIndex As Integer)
    OrdenarColunaTrueDB ssgProcurarEquipe, ColIndex, imgcima, imgbaixo
End Sub

Private Sub ssgProcurarEquipe_LostFocus()
    ssgProcurarEquipe.Visible = False
End Sub

Private Sub ssgProcurarEquipe_RowColChange(LastRow As Variant, ByVal LastCol As Integer)
    ssgProcurarEquipe_Click
End Sub
...
Private Sub tbBotoes_DblClick()
On Error GoTo Erro
       
      txtNomeEquipe.Text = objrs

Exit Sub
Erro:
   Call MsgBox("Erro no módulo: " & "frmCadastroDeEquipeV2" & vbCrLf & "tbBotoes_DblClick" & "VerificarCampos" & vbCrLf & "Descrição: " & Err.Description & vbCrLf & "Número: " & Err.Number & vbCrLf & "Na linha: " & Erl & vbCrLf & "Entre em contato com o suporte e mostre esta mensagem!", vbOKOnly + vbCritical, "Atenção!")
...
Private Sub txtNomeEquipe_KeyDown(KeyCode As Integer, Shift As Integer)
10    On Error GoTo Erro
            
20        If KeyCode = vbKeyReturn And mstrFlag = "" Then
30            Set mobjRsEquipes = Nothing
              
40            Call modEquipe_SelecionarEquipePorDescricao(txtNomeEquipe.Text, mobjRsEquipes)
              
50            If Not mobjRsEquipes Is Nothing Then
60                If Not mobjRsEquipes.BOF And Not mobjRsEquipes.EOF Then
70                    If mobjRsEquipes.RecordCount > 0 Then
80                        ssgProcurarEquipe.DataSource = mobjRsEquipes
90                        ssgProcurarEquipe.Left = txtNomeEquipe.Left
100                       ssgProcurarEquipe.Top = txtNomeEquipe.Top + txtNomeEquipe.Height
110                       ssgProcurarEquipe.Visible = True
120                   End If
130               End If
140           End If
...
160   Exit Sub
Erro:
170      Call MsgBox("Erro no módulo: " & "frmCadastroDeEquipeV2" & vbCrLf & "txtNomeEquipe_KeyDown" & "VerificarCampos" & vbCrLf & "Descrição: " & Err.Description & vbCrLf & "Número: " & Err.Number & vbCrLf & "Na linha: " & Erl & vbCrLf & "Entre em contato com o suporte e mostre esta mensagem!", vbOKOnly + vbCritical, "Atenção!")
