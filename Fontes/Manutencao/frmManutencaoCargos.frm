   ...
   Begin VB.Frame frmPrincipal 
      ...
      Begin VB.Frame fraAltercoes 
         ...
         Begin VB.CheckBox chkAtibo 
            ...
            Width           =   855
         End
         Begin VB.TextBox txtDescricaoCargo 
            Appearance      =   0  'Flat
            Height          =   405
            Left            =   60
            MaxLength       =   100
...
10        If cmdAlterar.Caption = "Alterar" Then
20            cmdAlterar.Caption = "Gravar"
30            cmdAdicionar.Enabled = False
40            txtDescricaoCargo.Text = mobjRsCargos!Cargo_VC
50            chkAtibo.Value = IIf(mobjRsCargos!Ativo_BT = True, vbChecked, vbUnchecked)
60            ssgCargos.Enabled = False
70        Else
80            AdicionarAlterarCargo txtDescricaoCargo.Text, IIf(chkAtibo.Value = vbChecked, True, False), 2
90            cmdAlterar.Caption = "Alterar"
100           cmdAdicionar.Enabled = True
110           ssgCargos.Enabled = True
120           CarregarCargos
130       End If
End Sub
...
20        modManutencao_SelecionarCargos mobjRsCargos, , False
30        ssgCargos.DataSource = mobjRsCargos

40    Exit Sub
Erro:
50       Call MsgBox("Erro no módulo: " & "frmCargos" & vbCrLf & "CarregarCargos" & "VerificarCampos" & vbCrLf & "Descrição: " & Err.Description & vbCrLf & "Número: " & Err.Number & vbCrLf & "Na linha: " & Erl & vbCrLf & "Entre em contato com o suporte e mostre esta mensagem!", vbOKOnly + vbCritical, "Atenção!")
End Sub

Private Sub AdicionarAlterarCargo(strCargo As String, blnAtivo As Boolean, lngOperacao As Long)
10    On Error GoTo Erro
...
20        Select Case lngOperacao
                  Case 1
30                    modManutencao_AdicionarAlterarCargo strCargo, blnAtivo
                  
40                Case 2
50                    modManutencao_AdicionarAlterarCargo strCargo, blnAtivo, mobjRsCargos!Cargo_IN
60        End Select
          

70    Exit Sub
Erro:
80       Call MsgBox("Erro no módulo: " & "frmCargos" & vbCrLf & "AdicionarAlterarCargo" & "VerificarCampos" & vbCrLf & "Descrição: " & Err.Description & vbCrLf & "Número: " & Err.Number & vbCrLf & "Na linha: " & Erl & vbCrLf & "Entre em contato com o suporte e mostre esta mensagem!", vbOKOnly + vbCritical, "Atenção!")
