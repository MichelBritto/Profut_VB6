CREATE PROCEDURE dbo.USP_ALTERARJOGADOR
    (
      @ID_IN INT ,
...
AS 
    ...
    SET     APELIDO_VC = @APELIDO_VC ,
            CARTEGORIA_IN = (CASE WHEN @CARTEGORIA_IN < dbo.FNC_VALIDARCARTEOGORIAJOGADOR(@ID_IN) THEN dbo.FNC_VALIDARCARTEOGORIAJOGADOR(@ID_IN) ELSE @CARTEGORIA_IN END) ,
            EQUIPE_IN = @EQUIPE_IN ,
            ...
            TELEFONEESCOLA_VC = @TELEFONEESCOLA_VC
