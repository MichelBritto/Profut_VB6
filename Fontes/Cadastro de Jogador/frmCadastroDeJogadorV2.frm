...
40       rptFichaJogador.Parametros111 = Val(mobjrsJogador!CODIGOUNICO_VC) '(Val(txtCodigoInterno.Text))
...
80       rptFichaJogador.Parametros5 = (sscCartegoria.Columns("chdescricao").Value)
...
'--------------------------------------------------------------------------------------
            ...
            '06-04-2021 Coloquei aqui pois gerava um bug quando o usuário trocava o código e clicava em alterar
