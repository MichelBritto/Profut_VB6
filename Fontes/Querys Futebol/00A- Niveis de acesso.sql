IF(SELECT COUNT(*) FROM SYSOBJECTS WHERE NAME LIKE 'Permissao_T' AND xtype = 'U') = 0
BEGIN
...
(
	...
	Status_BT BIT NOT NULL
	CONSTRAINT PK_Permissao_T PRIMARY KEY(Permissao_IN)
)
END

GO
IF(SELECT COUNT(*) FROM SYSOBJECTS WHERE NAME LIKE 'Usuario_T' AND xtype = 'U') = 0
BEGIN
...
GO
IF(SELECT COUNT(*) FROM SYSOBJECTS WHERE NAME LIKE 'Cargo_T' AND xtype = 'U') = 0
BEGIN
...
GO
IF(SELECT COUNT(*) FROM SYSOBJECTS WHERE NAME LIKE 'CargoXPermissao_T' AND xtype = 'U') = 0
BEGIN
...
(
	...
	Permissao_IN INT NOT NULL,
	Cargo_IN INT NOT NULL
	CONSTRAINT PK_CargoXPermissao_T PRIMARY KEY(ID_IN),
